...
<div class="header">
    <div class="header-top">
        <div class="container">
            ...
            <div class="top-right">
                <ul>
                    <li><a href="{{route('cheakout')}}">Checkout</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu multi-column columns-3">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{route('products')}}"><img src="images/woo.jpg" alt=" "/></a>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{route('products')}}"><img src="images/woo1.jpg" alt=" "/></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    ...
                                                    <li><a href="{{route('products1')}}"> Underwear </a></li>
...
<div class="copy-section">
    <div class="container">
        <div class="copy-left">
            <p>&copy; 2020 New Shop . All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
        </div>
